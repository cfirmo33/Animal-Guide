...
public class GlideImageLoader
{
    ...
    {
        Glide.with(mContext).load(imageUrl).transition(DrawableTransitionOptions.withCrossFade()).apply(new RequestOptions()
    ...
    {
        Glide.with(mContext).load(imageUrl).apply(new RequestOptions().placeholder(R.drawable.place_holder_img)).into(image);
    }
}
