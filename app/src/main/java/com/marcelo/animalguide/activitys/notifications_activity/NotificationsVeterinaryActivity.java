...
public class NotificationsVeterinaryActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_notifications_veterinary);
    ...
    {
        bottomNavigationViewEx = findViewById(R.id.navigation_bottom_notifications_veterinary);
