...
import com.marcelo.animalguide.database.CheckDatabaseFirebase;
...
public class LoginActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener
{
    ...
    private CheckDatabaseFirebase checkFirebase = new CheckDatabaseFirebase();
    ...
    {
        return checkFirebase.getTypeAccount();
    }
    ...
    private void initializeGoogleSign()
    {
        GoogleSignInOptions googleSignInOptions = new GoogleSignInOptions
                ...
                .requestIdToken(getString(R.string.id_google_cloud_client))
                .requestEmail()
                .build();
