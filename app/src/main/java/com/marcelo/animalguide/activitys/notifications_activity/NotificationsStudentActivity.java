...
public class NotificationsStudentActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_notifications_student);
    ...
    {
        bottomNavigationViewEx = findViewById(R.id.navigation_bottom_notifications_student);
