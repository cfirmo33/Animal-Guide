...
public class GoogleMapsOwnerActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_google_maps_owner);
    ...
    {
        bottomNavigationViewEx = findViewById(R.id.navigation_bottom_maps_owner);
