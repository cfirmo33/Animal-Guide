...
public class GoogleMapsStudentActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_google_maps_student);
    ...
    {
        bottomNavigationViewEx = findViewById(R.id.navigation_bottom_maps_student);
