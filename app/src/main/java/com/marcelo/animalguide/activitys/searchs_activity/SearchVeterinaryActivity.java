...
public class SearchVeterinaryActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_search_veterinary);
    ...
    {
        bottomNavigationViewEx = findViewById(R.id.navigation_bottom_search_veterinary);
