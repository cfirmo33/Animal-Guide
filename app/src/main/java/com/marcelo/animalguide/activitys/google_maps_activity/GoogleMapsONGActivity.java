...
public class GoogleMapsONGActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_google_maps_ong);
    ...
    {
        bottomNavigationViewEx = findViewById(R.id.navigation_bottom_maps_ong);
        ...
        viewEx.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener()
        {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item)
            {
                switch (item.getItemId())
                {
                    ...
                    case R.id.ic_mapa:
                        startActivity(new Intent(activity, GoogleMapsONGActivity.class));
                        overridePendingTransition(R.anim.animation_fade_in, R.anim.animation_fade_out);
                        finish();
                        return true;
