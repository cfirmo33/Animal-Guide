...
public class RegisterVeterinaryActivity extends AppCompatActivity implements EasyPermissions.PermissionCallbacks
{
    ...
    {
        constraintLayout = findViewById(R.id.constraintLayoutVeterinary);
