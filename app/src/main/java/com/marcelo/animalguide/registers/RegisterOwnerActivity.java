...
public class RegisterOwnerActivity extends AppCompatActivity implements EasyPermissions.PermissionCallbacks
{
    ...
    public void initializeObjects()
    {
        ...
        editTextPasswordUser = findViewById(R.id.editTextPasswordRegisterOwner);
    ...
    private void getDataBundle()
    {
        ...
        if (bundle != null)
        {
            ...
            if (Objects.equals(getProvedor, "Google"))
            {
                ...
                inputTextPasswordRegisterOwner.setVisibility(View.GONE);
    ...
    {
        btnRegisterOwner.setEnabled(false);
        ...
        if (resultCode == RESULT_OK)
        {
            try
            {
                if (requestCode == SELECAO_CAMERA)
                {
                    ...
                    circleImageViewUser.setImageBitmap(imagem);
